    ...
    <body class="o-page">
        ...
        <div class="o-page__sidebar is-minimized js-page-sidebar">
            <div class="c-sidebar is-minimized">
                ...
                <ul class="c-sidebar__list">
                    ...
                    <li class="c-sidebar__item">
                        <a class="c-sidebar__link is-active" href="buy.php">
                            <span class="c-sidebar__icon">
        ...
        <main class="o-page__content">
            ...
            <div class="container-fluid">
                ...
                <span class="c-divider has-text u-m-xsmall">Buy E-Currency</span>

                <div class="row">
                    <div class="col-md-10">
                        <form class="c-card__body" method="POST" action="process.php?process=buy">
                            <div class="c-field u-mb-small">
                                ...
                                <select class="c-input" name="currency" id="currency" required>
                            ...
                            <div class="c-field u-mb-small">
                                ...
                                <input class="c-input" name="amount" type="text" id="amount" placeholder="Enter the dollar equivalence of E-currency" required>
                                <small class="c-field__message">
                                    <i class="fa fa-info-circle"></i>This is a required field
                                </small>
                            </div>
                            <div class="c-field u-mb-small">
                                <label class="c-field__label" for="acct_details">E-Currency Details</label> 
                                <textarea class="c-input" placeholder="Enter your wallet Id" name="acct_details" id="acct_details" cols="30" rows="1" required></textarea>
                                <small class="c-field__message">
                                    <i class="fa fa-info-circle"></i>This is a required field
                                </small>
                            </div>
                ...
                <div class="row">
                   <div class="col-md-6" style="margin:20px">
                    <ul style="list-style-type:disc;color:#7f8fa4;">
                        ...
                        <li>Enter your E-currency Details</li>
